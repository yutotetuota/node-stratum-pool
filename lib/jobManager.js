...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processTemplate = function(rpcData){
        ...
        if  (!isNewBlock && _this.currentJob.rpcData.previousblockhash !== rpcData.previousblockhash && _this.currentJob.rpcData.hashstateroot !== rpcData.hashstateroot && _this.currentJob.rpcData.hashutxoroot !== rpcData.hashutxoroot){
            isNewBlock = true;
