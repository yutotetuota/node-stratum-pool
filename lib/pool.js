...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    **/
    this.processBlockNotify = function(blockHash, sourceTrigger) {
        ...
        if (typeof(_this.jobManager.currentJob) !== 'undefined' && blockHash !== _this.jobManager.currentJob.rpcData.previousblockhash && blockHash !== _this.jobManager.currentJob.rpcData.hashstateroot && blockHash !== _this.jobManager.currentJob.rpcData.hashutxoroot){
            GetBlockTemplate(function(error, result){
                if (error)
