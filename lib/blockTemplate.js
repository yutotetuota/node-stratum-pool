...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            this.jobParams = [
                this.jobId,
                util.packUInt32LE(this.prevHashReversed).toString('hex'),
                ...
                util.packUInt32LE(this.hashstaterootReversed).toString('hex'),
                util.packUInt32LE(this.hashutxorootReversed).toString('hex'),
                true
            ];
        }
