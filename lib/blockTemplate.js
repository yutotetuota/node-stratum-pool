    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            this.jobParams = [
                ...
                util.packUInt32LE(this.generationTransaction[0].toString('hex')).toString('hex'),
                util.packUInt32LE(this.generationTransaction[1].toString('hex')).toString('hex'),
                util.packUInt32LE(this.merkleBranch).toString('hex'),
                util.packInt32LE(this.rpcData.version).toString('hex'),
                util.packUInt32LE(this.rpcData.bits).toString('hex'),
                util.packUInt32LE(this.rpcData.curttime).toString('hex'),
