...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    this.serializeHeader = function(merkleRoot, hashStateRoot, hashUTXORoot, nTime, nonce){
        ...
        if (rpcData.hashStateRoot){
             header.write(rpcData.hashStateRoot, position, 32, 'hex');
             header.write(rpcData.hashUTXORoot, position, 32, 'hex');
             position += 32;
        }
