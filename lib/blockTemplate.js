...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            this.jobParams = [
                this.jobId,
                util.packUInt32LE(this.rpcData.previousblockhash).toString('hex'),
                ...
                util.packInt32LE(this.rpcData.hashstateroot).toString('hex'),
                util.packInt32LE(this.rpcData.hashutxoroot).toString('hex'),
                true
            ];
        }
